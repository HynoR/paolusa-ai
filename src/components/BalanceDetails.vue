...
async function fetchBalanceHistory() {
  ...
  try {
    const response = await axios.get('https://labv.nloli.xyz/tako_web/gpt_history', { params: { token: ctoken } });
...
async function syncChatKey() {
  ...
  try {
    const response = await axios.post('/tako_web/gpt_sync', { token:ctoken, turn_site_payload: cloudflare_token });
