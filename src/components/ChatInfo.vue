<template>
  <el-card class="box-card">
    ...
    <el-alert :closable="false"
              ...
              title="您的ChatKey是私密信息，请勿泄露给他人，否则可能导致您的账号被滥用。该key仅用于个人对话和开发使用，为防止影响其他人使用，如需高量高并发(数据标注等量大并发多的情景)，请在交流群与我们联系拿到独享批发APIKey，批发价在目前价格的基础下继续优惠七到九折不等"
              type="warning"
    />
    <el-alert :closable="false"
    ...
    <div class="quick-actions">
      ...
      <div>
        <small style="color:red"> 灵车API不能完全确保稳定性，如果出现模型失效、过于卡顿(一分钟以上)、无效扣费等情况，请尝试切换其他模型或在群内反馈, 不要多次重试浪费余额，如有错误扣费可在群内反馈获得补偿。反馈官网客服没有用，官网客服仅处理机场问题</small>
    </div>
    </div>
